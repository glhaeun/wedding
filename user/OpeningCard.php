...
<body>
    <div class="container-inv">
        ...
        <div class="sparkle-inv"></div>
        <div id="frame-1" class="frame-inv frame-1"></div>
        <div id="frame-2" class="frame-inv frame-2"></div>
        <div class="middle-circle-inv">
    ...
    <div class="landing-inv">
        <div class="golden-blur golden-blur-2"></div>
        <div class="golden-blur golden-blur-3"></div>
        <img class="landing-flower" src="assets/images/ziven/flowerLanding.png">
        <img class="element-landing-1" src="assets/images/ziven/element1.png">
        ...
        <p class="together-landing">08:00 pm</p>
        <p class="together-landing">at Wisma benteng restaurant</p>
    </div>
